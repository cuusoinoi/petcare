    ...
    <main class="main">
        ...
        <main class="content">
            <div class="form-container">
                ...
                <form action="<?= site_url('admin/treatment-courses/' . $course['treatment_course_id'] . '/sessions/store') ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.1" id="temperature" name="temperature" placeholder="VD: 38.5">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="pulse_rate" name="pulse_rate" placeholder="VD: 100">
                        </div>
                        <div class="form-group">
                            <label for="respiratory_rate">Nhịp thở (lần/phút)</label>
                            <input type="number" id="respiratory_rate" name="respiratory_rate" placeholder="VD: 20">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="overall_notes">Ghi chú tổng quát</label>
                        <textarea id="overall_notes" name="overall_notes" rows="4" placeholder="Nhập ghi chú..."></textarea>
                    </div>
