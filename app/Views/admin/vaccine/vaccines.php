                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            ...
                                            <a href="<?= site_url('admin/vaccines/delete/' . $row['vaccine_id']) ?>" class="btn btn-icon btn-delete" title="Xóa" onclick="return confirmDelete('Bạn có chắc muốn xóa vaccine này?', this.href)"><i class="fas fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
