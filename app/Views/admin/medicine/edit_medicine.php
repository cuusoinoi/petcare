    ...
    <main class="main">
        ...
        <main class="content">
            <div class="form-container">
                ...
                <?php endif; ?>
                <form action="<?= site_url('admin/medicines/update/' . $medicine['medicine_id']) ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="form-group">
                        <label for="name">Tên thuốc <span class="required-field">*</span></label>
                        <input type="text" id="name" name="name" value="<?= esc($medicine['medicine_name']) ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="route">Đường dùng</label>
                        <input type="text" id="route" name="route" value="<?= esc($medicine['medicine_route']) ?>">
                    </div>
