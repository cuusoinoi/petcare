                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            ...
                                            <a href="<?= site_url('admin/medicines/delete/' . $row['medicine_id']) ?>" class="btn btn-icon btn-delete" title="Xóa" onclick="return confirm('Bạn có chắc muốn xóa?')"><i class="fas fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
