    ...
    <main class="main">
        ...
        <main class="content">
            ...
            <div class="search-box">
                ...
                <a href="<?= site_url('admin/invoices/add') ?>" class="btn btn-add"><i class="fas fa-plus"></i> Tạo hóa đơn</a>
            </div>
                        ...
                        <?php if (!empty($invoices)): ?>
                            <?php foreach ($invoices as $row): ?>
                                <tr>
                                    ...
                                    <td><?= number_format($row['deposit'], 0, ',', '.') ?> đ</td>
                                    <td class="text-success"><?= number_format($row['total_amount'], 0, ',', '.') ?> đ</td>
                                    <td>
                                        <div class="actions">
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr><td colspan="8">Chưa có hóa đơn nào.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                <?php if ($totalPages > 1): ?>
